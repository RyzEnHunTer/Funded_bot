"""
USDJPY Portfolio Simulation
Runs the portfolio: USDCAD + EURUSD + USDJPY
Includes Exhaustion Detection and outputs a detailed trade journal.
"""
...
def run_sim():
    ...
    print(f"\n{'=' * 70}")
    print(f"  NEW PORTFOLIO: USDCAD, EURUSD, USDJPY")
    ...
    # Trade Journal
    print("\n\n" + "=" * 120)
    print("  DETAILED TRADE JOURNAL (Every Trade)")
    print("=" * 120)
    ...
    for idx, t in enumerate(closed_trades, 1):
        ...
        tag = " <<< BRAIN" if reason == "ml_flip_exit" else ""
    ...
    # ML Flip Breakdown
    ml_flips = [t for t in closed_trades if t['reason'] == 'ml_flip_exit']
    if ml_flips:
        print("\n\n" + "=" * 100)
